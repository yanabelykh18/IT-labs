...
void drawClock(int hour, int min, int second) {
	...
	for (float i = 0.01; i < 0.01; i += 0.01) {
		glBegin(GL_LINES);
		glVertex2f(arrow * (-0.44 - i), 0.5);
		glVertex2f(arrow * (-0.48 - i), -0.5);
		glVertex2f(arrow * (-0.50 - i), 0.5);
		glVertex2f(arrow * (-0.50 - i), -0.5);
		glVertex2f(arrow * (-0.48 - i), 0.5);
		glVertex2f(arrow * (-0.44 - i), -0.5);
		glEnd();
	...
	//draw minsector
	glColor3f(1, 0.5, 0); //Sets the current color
	glLineWidth(4);
	...
	/*//draw secsector 
	glColor3f(1, 1, 0); //Sets the current color
	glLineWidth(3);
	...
	//draw secArrow
	glColor3f(0.75, 0.75, 0); //Sets the current color
	glLineWidth(2);
